...
def build_toc(id: str) -> ReportSection:
...
def build_alkalinity(id: str) -> ReportSection:
    section = ReportSection(id)
...
def build_bacteria(id: str) -> ReportSection:
    section = ReportSection(id)
    ...
    row_builders.add_footer_row(section, "Heterotrophic Plate Count")
    return section
