...
def build_density(id: str) -> ReportSection:
    section = ReportSection(id)
    ...
    row_builders.add_footer_row(section, "Analysis by Gay-Lussac Pycnometer")
    return section


def build_lpc(id: str) -> ReportSection:
    section = ReportSection(id)
...
def build_apha(id: str) -> ReportSection:
    section = ReportSection(id)
    row_builders.add_simple_header_row(section, "Parameter", "Result")
    row_builders.add_analyte_row(section, "APHA number", "")
    row_builders.add_footer_row(section, "Analysis by UV-Vis (average of six replicates)")
    return section
